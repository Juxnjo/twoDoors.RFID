...
function posttags ()
{
    ...
    if ( document.getElementById( 'txtSalesOrder' ).value != '' || document.getElementById( 'txtSalesOrder2' ).value != '' )
    {
        sFilter = '{"filters":[';

        if ( document.getElementById( 'txtSalesOrder' ).value != '' )
        {
            sFilter += '{"SalesOrder":"' + document.getElementById( 'txtSalesOrder' ).value + '"}';
        }

        if ( document.getElementById( 'txtSalesOrder2' ).value != '' )
        {
            if ( document.getElementById( 'txtSalesOrder' ).value != '' )
            {
                sFilter += ',';
            }
            sFilter += '{"SalesOrder":"' + document.getElementById( 'txtSalesOrder2' ).value + '"}';
        }
...
function actualizar ()
{
    ...
    var customPropValue2 = document.getElementById( 'txtSalesOrder2' ).value.trim()

    if (customPropValue === "" && customPropValue2 === "") {
        alert("Ingrese el numero de pedido 1 y 2.");
        return;
    } else if (customPropValue === "") {
        
        alert("Ingrese el numero de pedido 1.");
        return;
    } else if (customPropValue2 === "") {
